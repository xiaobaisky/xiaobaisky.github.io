(() => {
    const utilsFn = {
        ...
        diffDate: (d, more = false) => {
            ...
            if (sco.is_Post()) {
                return datePost.toLocaleDateString('zh-CN', {year: 'numeric', month: '2-digit', day: '2-digit'}).replace(/\//g, '-');
            } else {
                if(dateNow.getFullYear() === datePost.getFullYear()) {
                    if (dayCount >= 6) {
                        return datePost.toLocaleDateString('zh-CN', {month: '2-digit', day: '2-digit', separator: '/' })
                    } else if (dayCount >= 1) {
                    ...
                    return datePost.toLocaleDateString('zh-CN', {year: 'numeric', month: '2-digit', day: '2-digit', separator: '/' })
                }
